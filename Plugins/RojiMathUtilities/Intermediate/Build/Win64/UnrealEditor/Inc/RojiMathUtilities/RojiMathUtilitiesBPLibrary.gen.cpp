...
// End Cross Module References
	...
	DEFINE_FUNCTION(URojiMathUtilitiesBPLibrary::execCreateCircleOfLife)
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_Circles);
		P_GET_PROPERTY(FDoubleProperty,Z_Param_Radius);
		P_GET_TARRAY_REF(FVector,Z_Param_Out_CircleLocations);
		P_GET_TARRAY_REF(FVector,Z_Param_Out_OutPoints);
		P_GET_TARRAY_REF(FVector,Z_Param_Out_OutAngles);
		P_FINISH;
		P_NATIVE_BEGIN;
		URojiMathUtilitiesBPLibrary::CreateCircleOfLife(Z_Param_Circles,Z_Param_Radius,Z_Param_Out_CircleLocations,Z_Param_Out_OutPoints,Z_Param_Out_OutAngles);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(URojiMathUtilitiesBPLibrary::execCreateCircleOfLifeGrid)
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_Circles);
		P_GET_PROPERTY(FDoubleProperty,Z_Param_Radius);
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		URojiMathUtilitiesBPLibrary::CreateCircleOfLifeGrid(Z_Param_Circles,Z_Param_Radius,Z_Param_XSpacing,Z_Param_YSpacing,Z_Param_Out_CircleLocations,Z_Param_Out_OutPoints);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(URojiMathUtilitiesBPLibrary::execCreateOpenPolygon)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		URojiMathUtilitiesBPLibrary::CreateOpenPolygon(Z_Param_Out_InPoints,Z_Param_InnerRadius,Z_Param_OuterRadius,Z_Param_StartAngle,Z_Param_StopAngle,Z_Param_Sides,Z_Param_Out_OutPoints);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(URojiMathUtilitiesBPLibrary::execLoadFile)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_Module);
		P_GET_PROPERTY(FStrProperty,Z_Param_Path);
		P_GET_TARRAY_REF(FString,Z_Param_Out_OutStrings);
		P_GET_UBOOL_REF(Z_Param_Out_Result);
		P_FINISH;
		P_NATIVE_BEGIN;
		URojiMathUtilitiesBPLibrary::LoadFile(Z_Param_Module,Z_Param_Path,Z_Param_Out_OutStrings,Z_Param_Out_Result);
		P_NATIVE_END;
	}
	void URojiMathUtilitiesBPLibrary::StaticRegisterNativesURojiMathUtilitiesBPLibrary()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "CreateCircleOfLife", &URojiMathUtilitiesBPLibrary::execCreateCircleOfLife },
			{ "CreateCircleOfLifeGrid", &URojiMathUtilitiesBPLibrary::execCreateCircleOfLifeGrid },
			...
			{ "LoadFile", &URojiMathUtilitiesBPLibrary::execLoadFile },
		};
	...
	struct Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics
	{
		struct RojiMathUtilitiesBPLibrary_eventCreateCircleOfLife_Parms
		{
			int32 Circles;
			double Radius;
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_Circles_MetaData[];
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_Circles;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_Radius_MetaData[];
#endif
		static const UECodeGen_Private::FDoublePropertyParams NewProp_Radius;
		static const UECodeGen_Private::FStructPropertyParams NewProp_CircleLocations_Inner;
		static const UECodeGen_Private::FArrayPropertyParams NewProp_CircleLocations;
		static const UECodeGen_Private::FStructPropertyParams NewProp_OutPoints_Inner;
		static const UECodeGen_Private::FArrayPropertyParams NewProp_OutPoints;
		static const UECodeGen_Private::FStructPropertyParams NewProp_OutAngles_Inner;
		static const UECodeGen_Private::FArrayPropertyParams NewProp_OutAngles;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Circles_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Circles = { "Circles", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLife_Parms, Circles), METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Circles_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Circles_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Radius_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLife_Parms, Radius), METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Radius_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Radius_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_CircleLocations_Inner = { "CircleLocations", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_CircleLocations = { "CircleLocations", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLife_Parms, CircleLocations), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_OutPoints_Inner = { "OutPoints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_OutPoints = { "OutPoints", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLife_Parms, OutPoints), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_OutAngles_Inner = { "OutAngles", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_OutAngles = { "OutAngles", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLife_Parms, OutAngles), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Circles,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_Radius,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_CircleLocations_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_CircleLocations,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_OutPoints_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_OutPoints,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_OutAngles_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::NewProp_OutAngles,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::Function_MetaDataParams[] = {
		{ "Category", "Roji|Math|PointGenerator" },
		{ "ModuleRelativePath", "Public/RojiMathUtilitiesBPLibrary.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URojiMathUtilitiesBPLibrary, nullptr, "CreateCircleOfLife", nullptr, nullptr, sizeof(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::RojiMathUtilitiesBPLibrary_eventCreateCircleOfLife_Parms), Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics
	{
		struct RojiMathUtilitiesBPLibrary_eventCreateCircleOfLifeGrid_Parms
		{
			int32 Circles;
			double Radius;
			int32 XSpacing;
		...
		static const UECodeGen_Private::FDoublePropertyParams NewProp_Radius;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_XSpacing_MetaData[];
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_XSpacing;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_YSpacing_MetaData[];
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_YSpacing;
		static const UECodeGen_Private::FStructPropertyParams NewProp_CircleLocations_Inner;
		static const UECodeGen_Private::FArrayPropertyParams NewProp_CircleLocations;
		static const UECodeGen_Private::FStructPropertyParams NewProp_OutPoints_Inner;
		static const UECodeGen_Private::FArrayPropertyParams NewProp_OutPoints;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Circles_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Circles = { "Circles", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLifeGrid_Parms, Circles), METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Circles_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Circles_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Radius_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLifeGrid_Parms, Radius), METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Radius_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Radius_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_XSpacing_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_XSpacing = { "XSpacing", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLifeGrid_Parms, XSpacing), METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_XSpacing_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_XSpacing_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_YSpacing_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_YSpacing = { "YSpacing", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLifeGrid_Parms, YSpacing), METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_YSpacing_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_YSpacing_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_CircleLocations_Inner = { "CircleLocations", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_CircleLocations = { "CircleLocations", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLifeGrid_Parms, CircleLocations), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_OutPoints_Inner = { "OutPoints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_OutPoints = { "OutPoints", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateCircleOfLifeGrid_Parms, OutPoints), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Circles,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_Radius,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_XSpacing,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_YSpacing,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_CircleLocations_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_CircleLocations,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_OutPoints_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::NewProp_OutPoints,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::Function_MetaDataParams[] = {
		{ "Category", "Roji|Math|PointGenerator" },
		{ "ModuleRelativePath", "Public/RojiMathUtilitiesBPLibrary.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URojiMathUtilitiesBPLibrary, nullptr, "CreateCircleOfLifeGrid", nullptr, nullptr, sizeof(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::RojiMathUtilitiesBPLibrary_eventCreateCircleOfLifeGrid_Parms), Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateOpenPolygon_Statics::NewProp_OutPoints_Inner = { "OutPoints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateOpenPolygon_Statics::NewProp_OutPoints = { "OutPoints", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventCreateOpenPolygon_Parms, OutPoints), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateOpenPolygon_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateOpenPolygon_Statics::NewProp_OutPoints_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateOpenPolygon_Statics::NewProp_OutPoints,
	};
#if WITH_METADATA
	...
	struct Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics
	{
		struct RojiMathUtilitiesBPLibrary_eventLoadFile_Parms
		{
			FString Module;
			FString Path;
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_Module_MetaData[];
#endif
		...
		static const UECodeGen_Private::FStrPropertyParams NewProp_OutStrings_Inner;
		static const UECodeGen_Private::FArrayPropertyParams NewProp_OutStrings;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Module_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Module = { "Module", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventLoadFile_Parms, Module), METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Module_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Module_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Path_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Path = { "Path", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventLoadFile_Parms, Path), METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Path_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Path_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_OutStrings_Inner = { "OutStrings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_OutStrings = { "OutStrings", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RojiMathUtilitiesBPLibrary_eventLoadFile_Parms, OutStrings), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Result_SetBit(void* Obj)
	{
		((RojiMathUtilitiesBPLibrary_eventLoadFile_Parms*)Obj)->Result = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(RojiMathUtilitiesBPLibrary_eventLoadFile_Parms), &Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Result_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Module,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Path,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_OutStrings_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_OutStrings,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::NewProp_Result,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::Function_MetaDataParams[] = {
		{ "Category", "Roji|Math|Utilities" },
		{ "ModuleRelativePath", "Public/RojiMathUtilitiesBPLibrary.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URojiMathUtilitiesBPLibrary, nullptr, "LoadFile", nullptr, nullptr, sizeof(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::RojiMathUtilitiesBPLibrary_eventLoadFile_Parms), Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URojiMathUtilitiesBPLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLife, "CreateCircleOfLife" }, // 4155099984
		{ &Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateCircleOfLifeGrid, "CreateCircleOfLifeGrid" }, // 3795987959
		{ &Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateGridInLayer, "CreateGridInLayer" }, // 2529901666
		{ &Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_CreateOpenPolygon, "CreateOpenPolygon" }, // 3530992351
		...
		{ &Z_Construct_UFunction_URojiMathUtilitiesBPLibrary_LoadFile, "LoadFile" }, // 361928745
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RojiMath_Plugins_RojiMathUtilities_Source_RojiMathUtilities_Public_RojiMathUtilitiesBPLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URojiMathUtilitiesBPLibrary, URojiMathUtilitiesBPLibrary::StaticClass, TEXT("URojiMathUtilitiesBPLibrary"), &Z_Registration_Info_UClass_URojiMathUtilitiesBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URojiMathUtilitiesBPLibrary), 421787299U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RojiMath_Plugins_RojiMathUtilities_Source_RojiMathUtilities_Public_RojiMathUtilitiesBPLibrary_h_3820653310(TEXT("/Script/RojiMathUtilities"),
